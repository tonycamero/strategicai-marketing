...
export default function HowItWorks() {
  usePageMeta({
    ...
    description: "See what happens to messy business information: evidence becomes a shared operating picture that people can disagree with, correct, and use before action.",
    path: "/how-it-works",
  });
