...
export default function NotFound() {
  usePageMeta({
    ...
    description: "This StrategicAI page is not available. Return to the current story about how your business actually works.",
      ...
      <main className="mx-auto flex min-h-[70vh] max-w-6xl items-center px-6 py-24">
        <section className="max-w-3xl">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <Link to="/founding100/offer" className="inline-flex items-center justify-center rounded-full border border-slate-700 px-7 py-4 text-base font-semibold text-white transition hover:border-slate-500 hover:bg-slate-900">See Founding 100 <ArrowRight size={17} className="ml-2" aria-hidden="true" /></Link>
          </div>
        </section>
      </main>
