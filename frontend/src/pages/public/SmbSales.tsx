            ...
            <main>
                ...
                <section className={styles.section}>
                    <div className="text-center max-w-4xl mx-auto mb-12">
                        ...
                        <a href={buildSignupUrl("smb_sales_hero")} target="_blank" rel="noopener noreferrer" className={styles.ctaButton}>Build My AI Brain</a>
                    </div>
                ...
                <section className={styles.section}>
                    <div className="text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                            <a href={buildSignupUrl("smb_sales_final")} target="_blank" rel="noopener noreferrer" className={styles.ctaButton}>Build My AI Brain</a>
