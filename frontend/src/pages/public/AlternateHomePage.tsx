      ...
      <main>
        <section className="relative overflow-hidden border-b border-slate-800/70">
          <div className="absolute inset-0">
            <img src="/images/brain-bg.jpg" alt="" className="h-full w-full object-cover opacity-10" />
        ...
        <section className={sectionClass} aria-labelledby="category-title">
          ...
          <p className="mt-10 text-xl font-medium text-cyan-200">The order matters: evidence before recommendations, scope before automation.</p>
        </section>
