...
export default function Founding100Offer() {
  ...
  usePageMeta({ title: "StrategicAI Founding 100 | See What It Includes", description: "Bring the real business, build a shared operating picture with StrategicAI, correct it, and use the approved Founding 100 experience to ask better questions.", path: "/founding100/offer" });
  ...
  return <Founding100FunnelChrome context="offer"><main className="f100-offer-main">
    ...
    <section className="f100-offer-section f100-offer-value" aria-labelledby="messy-title"><div><p className="f100-kicker">Bring the messy version</p><h2 id="messy-title">You do not need to clean up the business before you bring it.</h2></div><div><p>If the process bends, people disagree, a workaround exists for reasons nobody remembers, or an important answer still lives in one person’s head, that is useful evidence.</p><p>Start there.</p></div></section>
