...
const processSteps = [
  ...
  ["04", "Use it", "Business Views make parts of the picture easier to inspect. Nemo helps you follow real questions from the context you’ve built."],
] as const;
...
const faqs = [
  ["What do I actually receive?", "You build an initial body of Operational Intelligence about your company: a working picture, the Business Views supported by what we discover, explicit unknowns and corrections, and the approved Founding 100 Nemo experience. The exact views adapt to your business."],
  ["Is this a chatbot subscription?", "No. Nemo is useful because of the company context behind the conversation. The main work is building the understanding Nemo can work from."],
  ...
  ["Does this include custom software or integrations?", "Not automatically. Founding 100 begins with understanding the business. Custom implementation or capability work requires separate scope and approval."],
...
export default function Founding100Offer() {
  ...
  return <Founding100FunnelChrome context="offer"><main className="f100-offer-main">
    <section className="f100-offer-hero" aria-labelledby="f100-offer-title"><div className="f100-offer-hero-copy"><p className="f100-kicker">Founding 100 · First 100 businesses</p><h1 id="f100-offer-title">If everyone has a piece and you’re still the one putting it together, start here.</h1><p>For $299, StrategicAI begins building a working picture of how your business actually works—who knows what, how work moves, where it breaks, what still depends on you, and what remains unclear.</p><p>Then you get the authorized 90-day Nemo experience working from the company context you’ve built.</p><div className="f100-price"><strong>$299</strong><span>one time</span></div><CheckoutAction attribution={attribution} checkoutUrl={checkoutUrl} /></div><div className="f100-offer-brain" aria-hidden="true"><img src="/images/brain-bg.jpg" alt="" /></div></section>
    ...
    <section className="f100-offer-section f100-nemo" aria-labelledby="f100-nemo-title"><div className="f100-nemo-mark" aria-hidden="true">N</div><div><p className="f100-kicker">Then bring Nemo the questions you actually care about</p><h2 id="f100-nemo-title">Start with the hard question.</h2><p>For the authorized Founding 100 term, bring the real questions you are facing as an owner.</p><div className="f100-question-list"><span>What still depends on me?</span><span>Where does this process really break?</span><span>Do we actually need another person?</span><span>What should we understand before we automate?</span><span>What would break first if we grew?</span><span>What changed that nobody connected?</span></div><p className="f100-muted-copy">Nemo helps you reason from company context. It does not replace accountable leadership or professional advice.</p></div></section>
